...
# fazr pico - fora pco
od_bike[, hour_type := fifelse(start_hour %in% c(6, 7), "pico", 
...
st_write(od_pico_semana, "../../data/smtr_malha_cicloviaria/explore_od_tembici/viagens_por_od/viagens_od_pico_semana.gpkg", append = FALSE)
...
write_sheet(data = od_pico_semana %>% st_set_geometry(NULL) %>% slice(1:100),
            ss = ss,
            sheet = "Viagens por OD - Pico semana")
